...
instance Hashable Expr where
    hashWithSalt salt (Var s) = hash s
    hashWithSalt salt (Neg e) = hashWithSalt salt e + 3
    hashWithSalt salt (And l r) = hashWithSalt salt l + hashWithSalt salt r + 10
    hashWithSalt salt (Or l r) = hashWithSalt salt l + hashWithSalt salt r * 2
    hashWithSalt salt (Impl l r) = hashWithSalt salt l * 4 + hashWithSalt salt r
